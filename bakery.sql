...
CREATE TABLE `product_component` (
  ...
  CONSTRAINT `product_component_imbf1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_component_imbf2` FOREIGN KEY (`component_id`) REFERENCES `component` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
